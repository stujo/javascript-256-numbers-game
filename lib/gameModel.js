...
GameModel.prototype.left = function() {
    this._history.push(this.left_impl(this.currentState()));
}

GameModel.prototype.right = function() {
    this._history.push(this.right_impl(this.currentState()));
}

GameModel.prototype.down = function() {
    this._history.push(this.down_impl(this.currentState()));
}

GameModel.prototype.up = function() {
    this._history.push(this.up_impl(this.currentState()));
}
